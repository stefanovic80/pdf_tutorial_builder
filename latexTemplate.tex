...
Abbiamo anche visto, adoperando la carta millimetrata, che le infinite coppie ordinate che risolvono una equazione lineare come la eq. \ref{eq:eqLineare} \emph{giacciono tutte e solo} su una ben precisa retta (fig. \ref{fig:LibreOfficeCalc000}). %Si dice, a tal proposito, di \emph{equazione della retta}.

\input{latexScriptsToIncude_images/picture_000.tex}

%Inoltre, essendo infiniti i valori che posso scegliere per $x$, infiniti sono anche i valori che posso calcolare per $y$. Quindi, una equazione lineare come la eq. \ref{eq:eqLineare} ammette \emph{infinite soluzioni}.
...
\input{latexScriptsToIncude_images/picture_003.tex}
...
\input{latexScriptsToIncude_images/picture_004.tex}
...
\input{latexScriptsToIncude_images/picture_008.tex}
...
\input{latexScriptsToIncude_images/picture_009.tex}


\input{latexScriptsToIncude_images/picture_010.tex}


Selezioniamo ora le caselle $A3$, $B3$ e $C3$, come in figura \ref{fig:LibreOfficeCalc011}

\input{latexScriptsToIncude_images/picture_011.tex}
...
\input{latexScriptsToIncude_images/picture_012.tex}
...
\begin{enumerate}
	...
	\input{latexScriptsToIncude_images/picture_013.tex}
	...
	\input{latexScriptsToIncude_images/picture_014.tex}
	...
	\input{latexScriptsToIncude_images/picture_015.tex}

	
	\item Il grafico della figura \ref{fig:LibreOfficeCalc016} dovrebbe apparire

	\input{latexScriptsToIncude_images/picture_016.tex}
\end{enumerate}
...
\input{latexScriptsToIncude_images/picture_017.tex}
...
\input{latexScriptsToIncude_images/picture_018.tex}
...
\input{latexScriptsToIncude_images/picture_019.tex}


E il risultato dovrebbe essere quello di figura \ref{fig:LibreOfficeCalc020}

\input{latexScriptsToIncude_images/picture_020.tex}
...
\input{latexScriptsToIncude_images/picture_021.tex}
...
\input{latexScriptsToIncude_images/picture_022.tex}
...
\input{latexScriptsToIncude_images/picture_023.tex}


\section{Inserire una griglia più fitta}

\input{latexScriptsToIncude_images/picture_024.tex}

\input{latexScriptsToIncude_images/picture_025.tex}

\input{latexScriptsToIncude_images/picture_026.tex}

\newpage
\subsection{Infittire la griglia verticale}

\input{latexScriptsToIncude_images/picture_027.tex}

\input{latexScriptsToIncude_images/picture_028.tex}

\newpage
\subsection{Infittire la griglia orizzontale}

\input{latexScriptsToIncude_images/picture_029.tex}

\input{latexScriptsToIncude_images/picture_030.tex}
\end{document}